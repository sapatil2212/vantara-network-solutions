...
export default function DataCenterCTA() {
  return (
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to Build Your Data Center Infrastructure?
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Get enterprise-grade data center solutions with expert consultation, secure hosting, and 24×7 monitoring. Let&apos;s power your business together.
            </p>
