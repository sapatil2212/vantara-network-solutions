    ...
    <section className="py-16 md:py-20 bg-gray-50">
      <div className="container-custom px-4">
        <div 
          ...
          style={{
            backgroundImage: 'url(/images/core-services/telecom/telecom-cta.jpg)',
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Get Connected with Vantara
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Upgrade your business communication with fast, reliable, and secure telecom solutions tailored for your enterprise.
            </p>
