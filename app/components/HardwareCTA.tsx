    ...
    <section className="py-16 md:py-20 bg-gray-50">
      <div className="container-custom px-4">
        <div 
          ...
          style={{
            backgroundImage: 'url(/images/core-services/hardware/hardware-cta.jpg)',
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Get enterprise-grade hardware solutions tailored to your business needs. From servers to networking devices, we deliver quality products with expert support.
            </p>
